...
use crate::{assembly, Function, Instruction, Operand, Program, Register};
...
fn show_unary(op: assembly::UnaryOp) -> String {
    match op {
        assembly::UnaryOp::Neg => "negl".to_string(),
        assembly::UnaryOp::Not => "notl".to_string(),
    }
}
